          ...
          <Button variant="ghost" className="flex items-center gap-3 bg-[var(--bg-secondary)] hover:bg-[var(--bg-hover)] border border-[var(--border-primary)]">
            <div className="flex items-center gap-3">
              <div className="text-right">
                <p className="text-sm font-medium text-[var(--text-primary)]" style={{ fontFamily: 'Satoshi, sans-serif', fontStyle: 'normal' }}>{user.full_name || user.email}</p>
                {teamMember && (
                  <p className="text-xs text-[var(--text-secondary)]" style={{ fontFamily: 'Satoshi, sans-serif', fontStyle: 'normal' }}>{roleConfig.name || teamMember.role}</p>
                )}
              </div>
